...
import { LucideArrowRight, LucideCheckCircle, LucideCheckCircle2, Star } from 'lucide-react'
...
const userExist = await getAuthenticatedUser()
    ...
    <div className='w-full mx-auto py-8 px-4'>
            ...
            <div className="flex items-center mb-4">
               ...
               <div>
                ...
                <p className="text-muted-foreground text-sm">
                    Connect your Strip acoount to start accepting payments
                </p>
               </div>
            </div>
        </div>
            ...
            <div className="flex items-start">
                {
                    isConnected ? (
                        ...
                        <LucideCheckCircle className='h-5 w-5 text-amber-500 mt-0.5 mr-3 flex-shrink-0 ' />
                ...
                <div>
                    ...
                    <p className='text-sm text-muted-foreground mt-1'>
                       ...
                       : 'Connect your Stripe account to start processing payments and managing subscription'}
                    </p>
                </div>
            </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="text-sm text-muted-foreground">
                ...
                : "You'll be redierected to stripe to complete the connection"}
            </div>
...
{/* TODO: add the stripe link */}
            ...
            className={`px-5 py-2.5 rounded-md font-medium text-sm flex items-center gap-2 transition-colors ${isConnected
                ...
                >
                    ...
                    <LucideArrowRight size={16} className=''/>
                </Link>
        </div>
