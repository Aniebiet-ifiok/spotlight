...
import OnBoarding from "./_components/nBoarding";
import { Upload, Video } from "lucide-react";
import FeatureCard from "./_components/FeatureCard";
import FeatureSeectionLayout from "./_components/FeatureSeectionLayout";
...
const Home = (props: Props) => {
  return (
    <div className="w-full mx-auto h-full">
      ...
      <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-6 rounded-xl bg-backgroun-10">
        <FeatureSeectionLayout
