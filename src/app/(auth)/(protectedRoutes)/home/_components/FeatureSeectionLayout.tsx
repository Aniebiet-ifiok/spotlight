...
const FeatureSeectionLayout = ({
  ...
  return (
  <div className={`p-10 flex items-center justify-between flex-col gap-10 border rounded-3xl border border-border bg-background-10 ${className}`}>
    {children}
...
export default FeatureSeectionLayout